...
def can_update_using_update_method
  ...
  the_movie = Movie.find_by(title: "Wat?")
  the_movie.update!(title: "Wat, huh?")
end
...
def can_update_multiple_items_at_once
  ...
  hash_brown = { title: "A Movie" }
  #I wish...
  5.times do |i|
    Movie.update(hash_brown)
  end
end

def can_destroy_a_single_item
  Movie.create(title: "That One Where the Guy Kicks Another Guy Once")
  condemned_movie = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  condemned_movie.destroy
end
